...
\date{2007年3月17日}
\logo{\includegraphics[width=8cm]{../base-image/openlogo-light.eps}}
...
\begin{minipage}[t]{0.8\hsize}
 \begin{itemize}
 \item \includegraphics[width=0.2\hsize]{../base-image/janken-A.png} A #2\\
 \item \includegraphics[width=0.2\hsize]{../base-image/janken-B.png} B #3\\
 \item \includegraphics[width=0.2\hsize]{../base-image/janken-C.png} C #4\\
 \end{itemize}
\end{minipage}
}
\frame{\frametitle{問題\arabic{santakucounter}. #1}
...
\begin{frame}
 \includegraphics[width=0.8\hsize]{../2006-resume/image200611/meeting.jpg}
\end{frame}
