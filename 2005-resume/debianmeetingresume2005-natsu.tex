...
\vspace{0.5mm}
\hrule
\hfill{}\includegraphics[width=3cm]{../base-image/openlogo-nd.eps}\\
\vspace{-4cm}
\begin{center}
  \section{#1}
\end{center}
...
% 毎月変更する部分
\title{%\includegraphics[width=9cm]{../base-image/openlogo-nd.eps}\\
あんどきゅめんてっどでびあん}
\date{}
...
%\vfill{}
%\hfill{}
%\includegraphics[width=7cm]{../base-image/openlogo-nd.eps}
%\hfill{}
%\vfill{}
%\newpage
